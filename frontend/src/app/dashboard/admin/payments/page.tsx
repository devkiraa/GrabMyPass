            ...
            <div className="max-w-[1400px] mx-auto p-4 md:p-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-sm font-medium">
                                Oversight for all events • {payments.length} global pending.
                            </p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        <div className="h-10 px-4 bg-emerald-500 text-white flex items-center font-black text-sm">
                            LIVE
                        </div>
                    </div>
                </div>
                ...
                {loading && payments.length === 0 ? (
                    ...
                    <div className="py-20 bg-white border border-gray-100 flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="text-lg font-bold text-gray-900">Queue Cleared</h3>
                        <p className="text-gray-400 text-sm">No cross-event payments pending.</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
